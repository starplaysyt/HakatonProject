...
!function (t, e) {
    ...
    function Li(t) {
        return "angle" === t ? {between: J, compare: K, normalize: G} : {
            between: tt,
            compare: (t, e) => t - e,
            normalize: t => t
        }
            ...
            const n = ki(t.options.layout.padding), o = Math.max(e - n.width, 0), a = Math.max(i - n.height, 0),
                r = function (t) {
                    const e = function (t) {
                            ...
                            return e
                        }(t), i = Qi(e.filter((t => t.box.fullSize)), !0), s = Qi(Ji(e, "left"), !0),
                        n = Qi(Ji(e, "right")), o = Qi(Ji(e, "top"), !0), a = Qi(Ji(e, "bottom")), r = Zi(e, "x"),
                        l = Zi(e, "y");
                    return {
                        fullSize: i,
    ...
    class tn extends $s {
        ...
        _computeGridLineItems(t) {
            const e = this.axis, i = this.chart, s = this.options, {grid: n, position: a, border: r} = s, h = n.offset,
                c = this.isHorizontal(), d = this.ticks.length + (h ? 1 : 0), u = Js(n), f = [],
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, {position: s, ticks: a} = i, r = this.isHorizontal(),
                l = this.ticks, {align: h, crossAlign: c, padding: d, mirror: u} = a, f = Js(i.grid), g = f + d,
                ...
                l = this._getRingWeight(this.index), {
                    ...
                    if (e < O) {
                        const r = t, l = r + e, h = Math.cos(r), c = Math.sin(r), d = Math.cos(l), u = Math.sin(l),
                            ...
                            g = (t, e, s) => J(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i), p = f(0, h, d),
        ...
        g && function (t, e, i) {
            ...
            if (t.beginPath(), t.arc(n, o, a - h / 2, s + d / 2, i - d / 2), r > 0) {
                ...
                if ("round" === c) t.arc(n, o, e, i - C / 2, s + C / 2, !0); else if ("bevel" === c) {
                    const a = 2 * e * e, r = -a * Math.cos(i + C / 2) + n, l = -a * Math.sin(i + C / 2) + o,
                        h = a * Math.cos(s + C / 2) + n, c = a * Math.sin(s + C / 2) + o;
        ...
        __proto__: null, ArcElement: class extends $s {
            ...
            inRange(t, e, i) {
                const s = this.getProps(["x", "y"], i), {angle: n, distance: o} = X(s, {x: t, y: e}), {
                    ...
                    g = J(n, a, r) && a !== r, p = f >= O || g, m = tt(o, h + u, c + u);
                return p && m
            }
    ...
    class ya extends $s {
        ...
        _draw() {
            ...
            const {boxWidth: g, boxHeight: p, itemHeight: m} = _a(o, d), x = this.isHorizontal(),
    ...
    class Wa extends $s {
        ...
        getTitle(t, e) {
            const {callbacks: i} = e, s = Ba(i, "beforeTitle", this, t), n = Ba(i, "title", this, t),
        ...
        getFooter(t, e) {
            const {callbacks: i} = e, s = Ba(i, "beforeFooter", this, t), n = Ba(i, "footer", this, t),
        ...
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = Ta(this, i), a = Object.assign({}, t, e), r = Ea(this.chart, i, a),
        ...
        _drawColorBox(t, e, i, s, n) {
            const a = this.labelColors[i], r = this.labelPointStyles[i], {boxHeight: l, boxWidth: h} = n,
                c = Si(n.bodyFont), d = Ia(this, "left", n), u = s.x(d),
        ...
        _updateAnimationTarget(t) {
            ...
            if (s || n) {
                ...
                if (!i) return;
                const o = this._size = Ta(this, t), a = Object.assign({}, i, this._size), r = Ea(e, t, a),
                    l = Ra(t, a, r, e);
